      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-700 mt-2 font-medium">Gerencie suas campanhas de abordagem</p>
          </div>
          <Link
            href="/campaigns/new"
        ...
        {campaigns.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-8 text-center">
            <p className="text-gray-700 mb-4 font-medium">Ainda não há campanhas cadastradas</p>
            <Link
              href="/campaigns/new"
